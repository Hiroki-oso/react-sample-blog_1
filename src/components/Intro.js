...
function intro() {
  return (
    <div className="flex mt-5 items-center gap-20 justify-between sm:flex-col">
      ...
      <div>
      <img src="https://img.freepik.com/free-vector/men-success-laptop-relieve-work-from-home-computer-great_10045-646.jpg?w=740&t=st=1659194063~exp=1659194663~hmac=61dbc92c4268555d68c1f6bdf586830a497437bb2daf313135d1404841919c21" 
      alt=""
